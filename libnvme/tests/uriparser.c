...
static struct test_data test_data[] = {
	...
	{ "Nvme+Tcp://192.168.1.1:1234",
	  "nvme", "192.168.1.1", .proto = "tcp", .port = 1234 },
	{ "NVME+tcp://discovery.example.com:4420/nqn.2014-08.org.nvmexpress.discovery/",
	  "nvme", "discovery.example.com", .proto = "tcp", .port = 4420,
	  .path = { "nqn.2014-08.org.nvmexpress.discovery", NULL }},
