 ...
 * @NVME_FEAT_AE_CCRCN_SHIFT:
 * @NVME_FEAT_AE_CCRCN_MASK:
 * @NVME_FEAT_AE_LHCN_SHIFT:
 * @NVME_FEAT_AE_LHCN_MASK:
 ...
 * @NVME_FEAT_KATO_TIMEOUT_SHIFT:
 * @NVME_FEAT_KATO_TIMEOUT_MASK:
...
enum nvme_feat {
	...
	NVME_FEAT_AE_CCRCN_SHIFT	= 20,
	NVME_FEAT_AE_CCRCN_MASK		= 0x1,
	NVME_FEAT_AE_LHCN_SHIFT		= 21,
	NVME_FEAT_AE_LHCN_MASK		= 0x1,
	...
	NVME_FEAT_KATO_TIMEOUT_SHIFT	= 0,
	NVME_FEAT_KATO_TIMEOUT_MASK	= 0xffffffff,
...
#define NVME_FEAT_AE_CCRCN(v)		NVME_GET(v, FEAT_AE_CCRCN)
#define NVME_FEAT_AE_LHCN(v)		NVME_GET(v, FEAT_AE_LHCN)
