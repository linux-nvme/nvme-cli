...
{
	/*
	 * FreeBSD has no PCIe physical slot sysfs equivalent. It is only
	 * obtainable by parsing SMBIOS/dmidecode data, and there is no
	 * clean library wrapper for that today, so this stays unpopulated.
	 */
	return 0;
}
