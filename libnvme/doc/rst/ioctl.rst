...
.. c:function:: int nvme_subsystem_reset (struct nvme_transport_handle *hdl)
...
.. c:function:: int nvme_ctrl_reset (struct nvme_transport_handle *hdl)
...
.. c:function:: int nvme_ns_rescan (struct nvme_transport_handle *hdl)
