...
.. c:function:: const uint8_t * libnvme_ns_get_eui64 (const struct libnvme_ns *p)
...
.. c:function:: const uint8_t * libnvme_ns_get_nguid (const struct libnvme_ns *p)
...
.. c:function:: enum nvme_csi libnvme_ns_get_csi (const struct libnvme_ns *p)
