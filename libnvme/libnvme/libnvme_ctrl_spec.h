...
#define NVME_SPEC_CTRL_RAW_IDENTIFY_DATA_LEN		4096
#define NVME_SPEC_CTRL_VENDOR_SPECFIC_DATA_LEN		1024
#define NVME_SPEC_CTRL_SN_LEN				20
#define NVME_SPEC_CTRL_MN_LEN				40
#define NVME_SPEC_CTRL_FR_LEN				8
#define NVME_SPEC_CTRL_SUBNQN_LEN			256
#define NVME_SPEC_MXPS_001W				0
#define NVME_SPEC_MXPS_00001W				1
#define NVME_SPEC_IPS_NO_REPORT				0b00
#define NVME_SPEC_IPS_00001W				0b01
#define NVME_SPEC_IPS_001W				0b10
#define NVME_SPEC_APS_NO_REPORT				0b00
#define NVME_SPEC_APS_00001W				0b01
#define NVME_SPEC_APS_001W				0b10
 ...
 *	nvme_ctrls_free() or nvme_ctrl_free().
 */
_DLL_PUBLIC const char *nvme_ctrl_ieee_get(struct nvme_ctrl *cnt);
...
/**
 * nvme_ctrl_rrls_get() - Retrieve the RRLS property of specified NVMe
 * controller.
 *
 * Retrieve the RRLS(Read Recovery Levels Supported) property of specified NVMe
 * controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 ...
 *	uint16_t.
 */
_DLL_PUBLIC uint16_t nvme_ctrl_rrls_get(struct nvme_ctrl *cnt);

/**
 * nvme_ctrl_cntrltype_get() - Retrieve the CNTRLTYPE property of specified NVMe
 * controller.
 *
 * Retrieve the CNTRLTYPE(Controller Type) property of specified NVMe
 * controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 ...
 *	uint8_t.
 */
_DLL_PUBLIC uint8_t nvme_ctrl_cntrltype_get(struct nvme_ctrl *cnt);

/**
 * nvme_ctrl_crdt1_get() - Retrieve the CRDT1 property of specified NVMe
 * controller.
 *
 * Retrieve the CRDT1(Command Retry Delay Time 1) property of specified NVMe
 * controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 ...
 *	uint16_t.
 */
_DLL_PUBLIC uint16_t nvme_ctrl_crdt1_get(struct nvme_ctrl *cnt);

/**
 * nvme_ctrl_crdt2_get() - Retrieve the CRDT2 property of specified NVMe
 * controller.
 *
 * Retrieve the CRDT2(Command Retry Delay Time 2) property of specified NVMe
 * controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 ...
 *	uint26_t.
 */
_DLL_PUBLIC uint16_t nvme_ctrl_crdt2_get(struct nvme_ctrl *cnt);

/**
 * nvme_ctrl_crdt3_get() - Retrieve the CRDT3 property of specified NVMe
 * controller.
 *
 * Retrieve the CRDT3(Command Retry Delay Time 3) property of specified NVMe
 * controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 ...
 *	uint16_t.
 */
_DLL_PUBLIC uint16_t nvme_ctrl_crdt3_get(struct nvme_ctrl *cnt);
...
/**
 * nvme_ctrl_hmminds_get() - Retrieve the HMMINDS property of specified
 * NVMe controller.
 *
 * Retrieve the HMMINDS(Host Memory Buffer Minimum Descriptor Entry Size)
 * property of specified NVMe controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 *	If this pointer is NULL, your program will be terminated by assert().
 ...
 *	uint32_t.
 */
_DLL_PUBLIC uint32_t nvme_ctrl_hmminds_get(struct nvme_ctrl *cnt);

/**
 * nvme_ctrl_hmmaxd_get() - Retrieve the HMMAXD property of specified
 * NVMe controller.
 *
 * Retrieve the HMMAXD(Host Memory Maximum Descriptors Entries) property of
 * specified NVMe controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 ...
 *	uint16_t.
 */
_DLL_PUBLIC uint16_t nvme_ctrl_hmmaxd_get(struct nvme_ctrl *cnt);

/**
 * nvme_ctrl_nsetidmax_get() - Retrieve the NSETIDMAX property of specified
 * NVMe controller.
 *
 * Retrieve the NSETIDMAX(NVM Set Identifier Maximum) property of specified NVMe
 * controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 ...
 *	uint16_t.
 */
_DLL_PUBLIC uint16_t nvme_ctrl_nsetidmax_get(struct nvme_ctrl *cnt);

/**
 * nvme_ctrl_endgidmax_get() - Retrieve the ENDGIDMAX property of specified
 * NVMe controller.
 *
 * Retrieve the ENDGIDMAX(NVM Set Identifier Maximum) property of specified NVMe
 * controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 ...
 *	uint16_t.
 */
_DLL_PUBLIC uint16_t nvme_ctrl_endgidmax_get(struct nvme_ctrl *cnt);

/**
 * nvme_ctrl_anatt_get() - Retrieve the ANATT property of specified
 * NVMe controller.
 *
 * Retrieve the ANATT(ANA Transition Time) property of specified NVMe
 * controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 ...
 *	uint8_t.
 */
_DLL_PUBLIC uint8_t nvme_ctrl_anatt_get(struct nvme_ctrl *cnt);

/**
 * nvme_ctrl_anacap_get() - Retrieve the ANACAP property of specified
 * NVMe controller.
 *
 * Retrieve the ANACAP(Asymmetric Namespace Access Capabilities) property of
 * specified NVMe controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 ...
 *	uint8_t.
 */
_DLL_PUBLIC uint8_t nvme_ctrl_anacap_get(struct nvme_ctrl *cnt);

/**
 * nvme_ctrl_anagrpmax_get() - Retrieve the ANAGRPMAX property of specified
 * NVMe controller.
 *
 * Retrieve the ANAGRPMAX(ANA Group Identifier Maximum) property of specified
 * NVMe controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 ...
 *	uint32_t.
 */
_DLL_PUBLIC uint32_t nvme_ctrl_anagrpmax_get(struct nvme_ctrl *cnt);

/**
 * nvme_ctrl_nanagrpid_get() - Retrieve the NANAGRPID property of specified
 * NVMe controller.
 *
 * Retrieve the NANAGRPID(Number of ANA Group Identifiers) property of specified
 * NVMe controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 ...
 *	uint32_t.
 */
_DLL_PUBLIC uint32_t nvme_ctrl_nanagrpid_get(struct nvme_ctrl *cnt);

/**
 * nvme_ctrl_pels_get() - Retrieve the PELS property of specified
 * NVMe controller.
 *
 * Retrieve the PELS(Persistent Event Log Size) property of specified NVMe
 * controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 ...
 *	uint32_t.
 */
_DLL_PUBLIC uint32_t nvme_ctrl_pels_get(struct nvme_ctrl *cnt);
...
/**
 * nvme_ctrl_nwpc_get() - Retrieve the NWPC property of specified
 * NVMe controller.
 *
 * Retrieve the NWPC(Namespace Write Protection Capabilities) property of
 * specified NVMe controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 ...
 *	uint8_t.
 */
_DLL_PUBLIC uint8_t nvme_ctrl_nwpc_get(struct nvme_ctrl *cnt);
...
/**
 * nvme_ctrl_mnan_get() - Retrieve the MNAN property of specified NVMe
 * controller.
 *
 * Retrieve the MNAN(Maximum Number of Allowed Namespaces) property of specified
 * NVMe controller.
 *
 * @cnt:
 *	Pointer of 'struct nvme_ctrl'.
 ...
 *	uint32_t.
 */
_DLL_PUBLIC uint32_t nvme_ctrl_mnan_get(struct nvme_ctrl *cnt);
