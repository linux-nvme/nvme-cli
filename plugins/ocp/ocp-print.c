...
void ocp_c3_log(struct libnvme_transport_handle *hdl,
...
void ocp_c5_log(struct libnvme_transport_handle *hdl,
...
void ocp_c7_log(struct libnvme_transport_handle *hdl,
