		...
		unsigned int nsid, const char *devname)
{
	...
	multi = json_create_object();
	json_object_add_value_int(multi, "guard check error",
							le16_to_cpu(smart->e2e_err_cnt.wear_level.min));
	json_object_add_value_int(multi, "application tag check error",
							le16_to_cpu(smart->e2e_err_cnt.wear_level.max));
	json_object_add_value_int(multi, "reference tag check error",
	...
	json_object_add_value_int(multi, "1-Bit Err",
							le16_to_cpu(smart->DRAM_UECC_Detection_Count.wear_level.max));
	json_object_add_value_int(multi, "2-Bit Err",
	...
	multi = json_create_object();
	json_object_add_value_int(multi, "parity error detected",
							le16_to_cpu(smart->SRAM_UECC_Detection_Count.wear_level.min));
	json_object_add_value_int(multi, "ecc error detection",
							le16_to_cpu(smart->SRAM_UECC_Detection_Count.wear_level.max));
	json_object_add_value_int(multi, "axi data parity errors",
	...
	multi = json_create_object();
	json_object_add_value_int(multi, "Read Cmd",
							le16_to_cpu(smart->Inflight_Command.wear_level.min));
	json_object_add_value_int(multi, "Write Cmd",
							le16_to_cpu(smart->Inflight_Command.wear_level.max));
	json_object_add_value_int(multi, "Admin Cmd",
		...
		unsigned int nsid, const char *devname)
{
	...
	printf("wear_leveling                   : %03d  %3d%%       min: %u, max: %u, avg: %u\n",
		...
		le16_to_cpu(smart->wear_leveling_cnt.wear_level.max),
		le16_to_cpu(smart->wear_leveling_cnt.wear_level.avg));
	printf("end_to_end_error_detection_count: %03d  %3d%%       "
			"guard check error: %u, "
