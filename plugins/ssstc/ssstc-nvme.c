...
struct nvme_additional_smart_log {
	...
	struct nvme_additional_smart_log_item	Internal_End_to_End_Detection_Count;
		...
		unsigned int nsid, const char *devname)
{
	...
	multi = json_create_object();
	json_object_add_value_int(multi, "guard check error", le16_to_cpu(smart->e2e_err_cnt.wear_level.min));
	json_object_add_value_int(multi, "application tag check error", le16_to_cpu(smart->e2e_err_cnt.wear_level.max));
	json_object_add_value_int(multi, "reference tag check error", le16_to_cpu(smart->e2e_err_cnt.wear_level.avg));
	json_object_add_value_object(entry_stats, "raw", multi);
	...
	json_object_add_value_int(entry_stats, "raw", 	int48_to_long(smart->reallocated_sector_count.raw));
	...
	json_object_add_value_int(entry_stats, "normalized", smart->uncorrectable_sector_count.norm);
	json_object_add_value_int(entry_stats, "raw", 	int48_to_long(smart->uncorrectable_sector_count.raw));
	...
	json_object_add_value_int(entry_stats, "raw", 	int48_to_long(smart->NAND_ECC_Detection_Count.raw));
	...
	json_object_add_value_int(entry_stats, "raw", 	int48_to_long(smart->NAND_ECC_Correction_Count.raw));
	...
	json_object_add_value_int(entry_stats, "raw", 	int48_to_long(smart->GC_Count.raw));
	...
	multi = json_create_object();
	//json_object_add_value_int(multi, "Enter Interrupt", le16_to_cpu(smart->DRAM_UECC_Detection_Count.wear_level.min));
	json_object_add_value_int(multi, "1-Bit Err", le16_to_cpu(smart->DRAM_UECC_Detection_Count.wear_level.max));
	json_object_add_value_int(multi, "2-Bit Err", le16_to_cpu(smart->DRAM_UECC_Detection_Count.wear_level.avg));
	json_object_add_value_object(entry_stats, "raw", multi);
	...
	multi = json_create_object();
	json_object_add_value_int(multi, "parity error detected", le16_to_cpu(smart->SRAM_UECC_Detection_Count.wear_level.min));
	json_object_add_value_int(multi, "ecc error detection", le16_to_cpu(smart->SRAM_UECC_Detection_Count.wear_level.max));
	json_object_add_value_int(multi, "axi data parity errors", le16_to_cpu(smart->SRAM_UECC_Detection_Count.wear_level.avg));
	json_object_add_value_object(entry_stats, "raw", multi);
	...
	json_object_add_value_int(entry_stats, "raw", 	int48_to_long(smart->Raid_Recovery_Fail_Count.raw));
	...
	multi = json_create_object();
	json_object_add_value_int(multi, "Read Cmd", le16_to_cpu(smart->Inflight_Command.wear_level.min));
	json_object_add_value_int(multi, "Write Cmd", le16_to_cpu(smart->Inflight_Command.wear_level.max));
	json_object_add_value_int(multi, "Admin Cmd", le16_to_cpu(smart->Inflight_Command.wear_level.avg));
	json_object_add_value_object(entry_stats, "raw", multi);
	json_object_add_value_object(dev_stats, "Inflight_Command", entry_stats);

	entry_stats = json_create_object();
	json_object_add_value_int(entry_stats, "#id", smart->Internal_End_to_End_Detection_Count.key);
	json_object_add_value_int(entry_stats, "normalized", 100);

	multi = json_create_object();
	json_object_add_value_int(multi, "read hcrc", le16_to_cpu(smart->Internal_End_to_End_Detection_Count.wear_level.min));
	json_object_add_value_int(multi, "write hcrc", le16_to_cpu(smart->Internal_End_to_End_Detection_Count.wear_level.max));
	json_object_add_value_int(multi, "reserved", le16_to_cpu(smart->Internal_End_to_End_Detection_Count.wear_level.avg));
	json_object_add_value_object(entry_stats, "raw", multi);
	...
	json_object_add_value_int(entry_stats, "raw", 	int48_to_long(smart->die_fail_count.raw));
	...
	json_object_add_value_int(entry_stats, "raw", 	int48_to_long(smart->wear_leveling_exec_count.raw));
	...
	json_object_add_value_int(entry_stats, "raw", 	int48_to_long(smart->read_disturb_count.raw));
	...
	json_object_add_value_int(entry_stats, "raw", 	int48_to_long(smart->data_retention_count.raw));
		...
		unsigned int nsid, const char *devname)
{
	...
	printf("end_to_end_error_detection_count: %03d  %3d%%       guard check error: %u, application tag check error: %u, reference tag check error: %u\n",
	...
	printf("DRAM_UECC_detection_count       : %03d  %3d%%       1-Bit Err: %u, 2-Bit Err: %u\n",
		...
		//le16_to_cpu(smart->DRAM_UECC_Detection_Count.wear_level.min),
		le16_to_cpu(smart->DRAM_UECC_Detection_Count.wear_level.max),
		le16_to_cpu(smart->DRAM_UECC_Detection_Count.wear_level.avg));
	
	printf("SRAM_UECC_Detection_Count       : %03d  %3d%%       parity error detected: %u, ecc error detection: %u, axi data parity errors: %u\n",
	...
	printf("Inflight_Command                : %03d  %3d%%       Read Cmd: %u, Write Cmd: %u, Admin Cmd: %u\n",
	...
	printf("internal_end_to_end_dect_count  : %03d  %3d%%       read hcrc: %u, write hcrc: %u, reserved: %u\n",
		smart->Internal_End_to_End_Detection_Count.key,
		//smart->Internal_End_to_End_Detection_Count.norm,
		100,
		le16_to_cpu(smart->Internal_End_to_End_Detection_Count.wear_level.min),
		le16_to_cpu(smart->Internal_End_to_End_Detection_Count.wear_level.max),
		le16_to_cpu(smart->Internal_End_to_End_Detection_Count.wear_level.avg));
...
int ssstc_get_add_smart_log(int argc, char **argv, struct command *cmd, struct plugin *plugin)
{
	...
	const char *desc =
	    "Get SSSTC vendor specific additional smart log (optionally, for the specified namespace), and show it.";
