...
static void show_ibm_vpd_log(struct nvme_ibm_vpd_log *vpd, const char *devname)
{
	...
	printf("Firmware version		: %.*s\n", (int) sizeof(vpdlog.firmware), vpd->firmware);
}
