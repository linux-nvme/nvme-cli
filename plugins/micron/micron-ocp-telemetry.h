...
struct __packed nvme_ocp_vendor_unique_dbg_evt_class_format
{
};
 ...
 * @return 0 success
 */
int get_telemetry_das_offset_and_size(struct nvme_ocp_telemetry_common_header *ptelemetry_common_header,
 ...
 * @return 0 success
 */
int parse_statistics(struct json_object *root, struct nvme_ocp_telemetry_offsets *pOffsets, FILE *fp);
 ...
 * @return 0 success
 */
int parse_event_fifos(struct json_object *root, struct nvme_ocp_telemetry_offsets *poffsets, FILE *fp);
