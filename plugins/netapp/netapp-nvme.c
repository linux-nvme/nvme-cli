...
static int nvme_get_ontap_c2_log(struct dev_handle *hdl, __u32 nsid, void *buf, __u32 buflen)
{
...
static int netapp_smdevices_get_info(struct dev_handle *hdl, struct smdevice_info *item,
				     const char *dev)
{
	int err;
...
static int netapp_ontapdevices_get_info(struct dev_handle *hdl, struct ontapdevice_info *item,
		const char *dev)
{
	int err;
	void *nsdescs;
