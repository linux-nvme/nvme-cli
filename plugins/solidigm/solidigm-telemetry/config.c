...
static bool config_get_by_version(const json_object *obj, int version_major, int version_minor, json_object **value)
{
...
bool solidigm_config_get_by_token_version(const json_object *obj, int token_id, int version_major, int version_minor, json_object **value)
{
